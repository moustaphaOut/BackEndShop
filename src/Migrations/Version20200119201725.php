 ...
 */
final class Version20200119201725 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD price_tax_excl DOUBLE PRECISION NOT NULL, ADD price_tax_incl DOUBLE PRECISION NOT NULL, DROP old_price_product, DROP price_product, CHANGE brand_product brand_product VARCHAR(60) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE image_product image_product VARCHAR(255) DEFAULT NULL, CHANGE is_active is_active TINYINT(1) DEFAULT NULL, CHANGE meta_keywords_product meta_keywords_product VARCHAR(255) DEFAULT NULL, CHANGE featured_image_id featured_image_id INT DEFAULT NULL');
